...
feature 'invite to Job seeker' do 
  ...
  scenario "job seeker invited by user", js: true do
    ...
    find('.yj-contact-list > li:nth-child(2) > a:nth-child(1)').click
  end

  scenario "job seeker invited by user Facebook", js: true do
    visit '/'
    find('.icon-menu').click
    find(:xpath, "//*[@id=\"slide-out\"]/li[4]/a").click
    expect(page).to have_content 'Email'
  ...
  scenario "job seeker invited by user for Twitter", js: true do
    visit '/'
    find('.icon-menu').click
    find(:xpath, "//*[@id=\"slide-out\"]/li[4]/a").click
    expect(page).to have_content 'Email'
  ...
  scenario "job seeker invited by user Copylink", js: true do
    visit '/'
    find('.icon-menu').click
    find(:xpath, "//*[@id=\"slide-out\"]/li[4]/a").click
    expect(page).to have_content 'Email'
